    ...
    <Row>
      <Card>
        ...
        <Steps :current="currentStep" :status="status">
          <Step v-for="item in stepList" :title="item.title" :content="item.describe + '审核并通过'" :key="item.title"></Step>
        </Steps>
      </Card>
    </Row>
  </div>
